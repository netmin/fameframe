...
import {Category, Fame} from "@prisma/client";
...
interface FameFormProps {
    initialData: Fame | null;
    categories: Category[];
}
...
export const FameForm = ({initialData, categories}: FameFormProps) => {
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        try {
            if (initialData) {
                await axios.patch(`/api/fame/${initialData.id}`, values);
            } else {
                await axios.post("/api/fame", values);
            }
            toast({
                description: "Success"
            })
                                ...
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input disabled={isLoading}
                                               placeholder="CEO & Founder of Tesla, SpaceX" {...field} />
                                    </FormControl>
                                    <FormDescription>
                    ...
                    <FormField
                        ...
                        render={({field}) => (
                            <FormItem>
                                ...
                                <FormDescription>
                                    Write couple of examples of a human chatting with your AI companion, write expected
                                    answers.
                                </FormDescription>
                                <FormMessage/>
                            </FormItem>
